    ...
    <PageTransition>
      <div className="relative min-h-screen bg-bg-dark text-slate-900 font-body pt-12 pb-24">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10 space-y-16">
          ...
          <Card variant="glass" className="p-6 md:p-10 border-slate-200 bg-white shadow-md">
            <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-start">
              ...
              <div className="lg:col-span-7 space-y-6">
                <div className="flex flex-wrap items-center gap-3">
                  ...
                  <span className="text-xs text-primary font-heading font-semibold flex items-center gap-1">
                ...
                <div className="p-4 rounded-xl bg-amber-50/60 border border-amber-200 space-y-2">
                  ...
                  <ul className="space-y-1 pl-6 list-disc text-xs text-slate-700 font-body">
                ...
                <div className="space-y-3">
                  <h3 className="text-sm font-bold font-heading text-slate-900 flex items-center gap-2">
                    <Sparkles className="w-4 h-4 text-primary" /> {selectedCase.solution.title}
                  </h3>
                ...
                <div className="pt-4 border-t border-slate-200">
                  <div className="text-xs font-heading font-semibold text-slate-500 uppercase tracking-wider mb-3">
                  ...
                  <div className="grid grid-cols-2 sm:grid-cols-4 gap-3">
                    {selectedCase.results.map((r, i) => (
                      <div key={i} className="p-3 rounded-xl bg-slate-50 border border-slate-200 text-center">
                        <div className="text-lg font-extrabold text-primary font-heading">{r.metric}</div>
              ...
              <div className="lg:col-span-5 space-y-6">
                <img
                  ...
                  className="w-full h-64 sm:h-72 rounded-2xl object-cover border border-slate-200 shadow-lg"
                />

                <div className="p-4 rounded-xl bg-slate-50 border border-slate-200 space-y-2">
                  <div className="text-xs font-heading font-bold text-slate-900">Qualitative Impact:</div>
                  <p className="text-xs text-slate-600 font-body italic leading-relaxed">
          ...
          <div className="space-y-4">
            <h3 className="text-lg font-bold font-heading text-slate-900">Explore More Proven Success Stories:</h3>
                ...
                <Card
                  ...
                  className={`p-4 border transition-all cursor-pointer ${
                    selectedCase.id === cs.id
                      ? "border-primary bg-blue-50/70 shadow-md"
                      : "border-slate-200 bg-white hover:border-slate-300"
                  }`}
                >
                  <div className="text-[10px] text-primary font-heading font-bold mb-1">{cs.industry}</div>
                  <div className="text-xs font-bold font-heading text-slate-900 line-clamp-2 mb-2">{cs.title}</div>
                  <div className="text-[10px] text-slate-500">{cs.location}</div>
                </Card>
              ))}
            </div>
          </div>
