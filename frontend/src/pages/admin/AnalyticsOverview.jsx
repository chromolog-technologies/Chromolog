  ...
  return (
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
        <Card variant="glass" className="p-5 border-white/10 bg-[#0a0d1d]/80 backdrop-blur-xl shadow-xl space-y-2">
          ...
          <p className="text-[11px] text-slate-400">Unique website visitors (30 days)</p>
        </Card>

        <Card variant="glass" className="p-5 border-white/10 bg-[#0a0d1d]/80 backdrop-blur-xl shadow-xl space-y-2">
          <span className="text-xs font-bold font-heading text-sky-300 uppercase tracking-wider">GA4 Total Sessions</span>
          <p className="text-2xl font-extrabold font-heading text-white">{(ga.sessions || 0).toLocaleString()}</p>
          <p className="text-[11px] text-slate-400">Total page sessions recorded</p>
        </Card>
        ...
        <Card variant="glass" className="p-5 border-white/10 bg-[#0a0d1d]/80 backdrop-blur-xl shadow-xl space-y-2">
          ...
          <p className="text-[11px] text-slate-400">Google Search result views</p>
        </Card>
        ...
        <Card variant="glass" className="p-5 border-white/10 bg-[#0a0d1d]/80 backdrop-blur-xl shadow-xl space-y-2">
          ...
          <p className="text-[11px] text-slate-400">Organic search referral clicks</p>
        </Card>
      </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-6">
        ...
        <div className="lg:col-span-5">
          <Card variant="glass" className="p-6 border-white/10 bg-[#0a0d1d]/80 backdrop-blur-xl shadow-xl space-y-4">
                ...
                <tbody className="divide-y divide-white/[0.04] font-body text-slate-300">
                  {sc.top_keywords?.map((kw, idx) => (
                    <tr key={idx} className="hover:bg-white/[0.02]">
                      ...
                      <td className="p-3 text-right text-slate-400">{kw.impressions.toLocaleString()}</td>
