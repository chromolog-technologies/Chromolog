...
export default function Hero({ navigateToSection }) {
  ...
  return (
    ...
    >
      ...
      <div className="max-w-[1440px] mx-auto px-6 lg:px-12 w-full z-10 grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-8 items-center mb-16 pointer-events-none">

        {/* Left Column: Copy & CTAs */}
        <div className="lg:col-span-8 flex flex-col text-left space-y-6 lg:pr-8">
          ...
          <motion.h1
            ...
            className="text-4xl sm:text-5xl md:text-6xl lg:text-[64px] font-extrabold tracking-tight text-white leading-[1.1] font-heading max-w-2xl drop-shadow-md"
          >
            Custom Software &amp;{" "}
          ...
          <motion.p
            ...
            className="text-base sm:text-lg text-slate-300 max-w-xl leading-relaxed font-body font-normal drop-shadow"
          >
      ...
      <div className="max-w-[1440px] mx-auto px-6 lg:px-12 w-full z-10 pointer-events-none">
          ...
          {featureCards.map((card, index) => {
            ...
            return (
              <motion.div
                ...
                className="bg-white/[0.04] backdrop-blur-2xl border border-white/15 rounded-2xl p-6 hover:border-cyan-400/60 hover:bg-white/[0.08] transition-all duration-300 shadow-[0_8px_32px_rgba(0,229,255,0.12)] group pointer-events-auto cursor-pointer"
              >
